...
things may help you:
{
    ...
    Github repo source codes: ~/ref/GPT-SoVITS
    Runnable tool: ~/ref/GPT-SoVITS-v2pro-20250604
    go-webui.bat
}
{
    vits-simple-api-windows-gpu-v0.6.15
    Github repo source codes: ~/ref/vits-simple-api
    Runnable tool: ~/ref/vits-simple-api-windows-gpu-v0.6.15
    start.bat
}
