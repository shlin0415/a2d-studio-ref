...
class DialogueParser:
    ...
    def parse_raw_response(
        ...
        for unit in dialogue_units:
            try:
                ...
                logger.warning(
                    f"Failed to parse dialogue unit: {unit[:50]}... Error: {e}"
                )
                continue
    ...
    def parse_dialogue_unit(
        ...
        if translation_match:
            ...
            remaining_text = (
                remaining_text[: translation_match.start()]
                + remaining_text[translation_match.end() :]
            )
        ...
        if action_match:
            ...
            remaining_text = (
                remaining_text[: action_match.start()]
                + remaining_text[action_match.end() :]
            )
